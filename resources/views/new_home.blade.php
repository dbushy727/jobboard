...
<head>
    ...
    <link rel="icon" type="image/png" href={{env('APP_URL')}}/favicons/favicon-32x32.png?v=GvJBvwNAXW" sizes="32x32">
    <link rel="icon" type="image/png" href={{env('APP_URL')}}/favicons/favicon-16x16.png?v=GvJBvwNAXW" sizes="16x16">
