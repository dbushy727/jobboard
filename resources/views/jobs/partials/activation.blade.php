<div class="activation-buttons">
    <form action="/jobs/{{$job->slug}}/reject" method="POST" class="form activation-form">
    ...
    <form action="/jobs/{{$job->slug}}/activate" method="POST" class="form activation-form pull-right">
        <div class="form-group">
            {!! csrf_field() !!}
